...
import type { L1Sender, L1SenderInterface } from "../L1Sender";
...
export class L1Sender__factory {
  static readonly abi = _abi;
  static createInterface(): L1SenderInterface {
    return new utils.Interface(_abi) as L1SenderInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): L1Sender {
    return new Contract(address, _abi, signerOrProvider) as L1Sender;
  }
}
