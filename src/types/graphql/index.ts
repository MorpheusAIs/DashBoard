...
export type BuilderProjectFragment = {
  __typename?: 'BuildersProject'
  admin: any
  claimLockEnd: any
  id: any
  ...
  totalStaked: any
  totalUsers: any
  withdrawLockPeriodAfterDeposit: any
}
...
export type GetBuildersProjectsQuery = {
  __typename?: 'Query'
  buildersProjects: Array<{
    __typename?: 'BuildersProject'
    admin: any
    claimLockEnd: any
    id: any
...
export type GetBuildersProjectsByIdsQuery = {
  __typename?: 'Query'
  buildersProjects: Array<{
    __typename?: 'BuildersProject'
    admin: any
...
export type GetBuildersProjectQuery = {
  __typename?: 'Query'
  buildersProject?: {
    __typename?: 'BuildersProject'
    admin: any
...
export type GetAccountUserBuildersProjectsIdsQuery = {
  __typename?: 'Query'
  buildersUsers: Array<{ __typename?: 'BuildersUser'; buildersProjectId: any }>
}
...
export type GetBuildersProjectUsersQuery = {
  __typename?: 'Query'
  buildersUsers: Array<{
    __typename?: 'BuildersUser'
    address: any
    buildersProjectId: any
    id: any
    staked: any
  }>
}
...
export const GetUserAccountBuildersProject = gql`
  query getUserAccountBuildersProject(
    ...
    buildersUsers(
      where: { buildersProjectId: $buildersProjectId, address: $address }
    ) {
      id
      staked
      lastStake
